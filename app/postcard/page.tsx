    ...
    <>
      ...
      >
        ...
        <div className="absolute top-4 right-4 z-30">
          <Link
            href="/inbox"
            className="bg-white/90 hover:bg-white backdrop-blur-md border border-gray-200 text-gray-800 px-6 py-3 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl flex items-center gap-2"
          >
            <span>📬</span>
                ...
                <div className="flex-1 flex items-center justify-center p-12">
                  <textarea
                    ...
                    style={{
                      ...
                      pointerEvents: 'auto', // Ensure textarea is clickable
